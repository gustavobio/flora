...
get_domains <- function(taxa) {
  ...
  get_sp_domain <- function(id) {
    ...
    sp_info <- fromJSON(paste0("http://floradobrasil.jbrj.gov.br/reflora/listaBrasil/ConsultaPublicaUC/ResultadoDaConsultaCarregaTaxonGrupo.do?&idDadosListaBrasil=", id))
